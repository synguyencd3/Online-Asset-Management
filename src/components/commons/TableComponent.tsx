                                    ...
                                    <tr key={a.id}>
                                        ...
                                        <td className='last-cell'>
                                            <Container>
                                                <Row className='g-3'>
                                                    <Col lg={3}>
                                                        <Button variant='outline-danger' disabled={a.state == AssignmentState.ACCEPTED} onClick={(e) => { console.log(e); window.alert("You Click Edit") }} style={{ color: "black" }}>
                                                            <FontAwesomeIcon size='lg' icon={faPencil} />
                                                        </Button>
                                                    </Col>
                                                    <Col lg={3}>
                                                        <Button variant='outline-danger' disabled={a.state == AssignmentState.ACCEPTED} onClick={(e) => { console.log(e); window.alert("You Click Remove") }}>
                                                            <FontAwesomeIcon size='lg' className='xMark' icon={faCircleXmark} />
                                                        </Button>
                                                    </Col>
                                                    <Col lg={3}>
                                                        <Button variant='outline-danger' disabled={a.state == AssignmentState.ACCEPTED} onClick={(e) => { console.log(e); window.alert("You Click Restart") }}>
                                                            <FontAwesomeIcon size='lg' style={{ color: "blue" }} icon={faArrowRotateLeft} />
                                                        </Button>
                                                    </Col>
                                                </Row>
                                            </Container>
